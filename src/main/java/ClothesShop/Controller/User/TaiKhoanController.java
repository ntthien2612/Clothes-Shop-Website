...
public class TaiKhoanController {
	...
	// ĐĂNG KÝ TÀI KHOẢN
		...
		public ModelAndView CreateAcc(@ModelAttribute("user") Users user, HttpSession session) {
			int count = accountService.AddAccount(user);
//			session.setAttribute("dem", userDao.Count(user.getEmail_kh()));
//			int c = (int)session.getAttribute("dem");
//			System.out.print(c);
			if (count >0) {
