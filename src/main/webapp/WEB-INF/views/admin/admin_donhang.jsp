		...
		<div class="col-sm-2 sidenav" style="text-align: left; height: 150%">
			...
			<p>
				<a class="nav-link" href="quanlynhanvien"> <i
					class="bi bi-people-fill"></i> Quản Lý Nhân Viên
				</a>
			</p>
			<p>
			...
			<table>
				...
				<c:forEach var="donhang" items="${donhang}" varStatus="index">
					<tr>
						...
						<td>${donhang.trangthai }<c:if
								test="${donhang.trangthai eq 'Chờ xác nhận'}">
								<a href="xacnhan?don=${donhang.id_dh }"><button>Xác
										nhận</button></a>
							</c:if>
						</td>
						<td><a href="chitietdonhang?don=${donhang.id_dh }">Chi
								Tiết</a></td>
					</tr>
				</c:forEach>
