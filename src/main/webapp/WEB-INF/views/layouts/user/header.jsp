	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a class="" href="./"> <span class="icon-home"></span> Trang chủ
				</a>
				...
				<c:if test="${ not empty LoginInfo }">
					<a href="./chi-tiet-khach-hang?id_kh=${LoginInfo.id_kh}"><span
						class="icon-user"></span> ${ LoginInfo.ten_kh }</a>
	...
	<div class="navbar-inner">
		<div class="container">
			...
			<div class="nav-collapse">
				...
				<!--Tìm kiếm sản phẩm -->
				<form action="sanpham" class="navbar-search pull-left" style=" margin-left: 50% " modelAttribute="sanpham">
